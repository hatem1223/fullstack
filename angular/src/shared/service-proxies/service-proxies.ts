...
export class DepartmentServiceProxy {
    ...
    protected processGet(response: HttpResponseBase): Observable<DepartmentDTO> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? DepartmentDTO.fromJS(resultData200) : new DepartmentDTO();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfDepartmentDTO> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfDepartmentDTO> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfDepartmentDTO.fromJS(resultData200) : new PagedResultDtoOfDepartmentDTO();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    create(input: DepartmentDTO | null | undefined): Observable<DepartmentDTO> {
     ...
     * @return Success
     */
    update(input: DepartmentDTO | null | undefined): Observable<DepartmentDTO> {
...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<EmployeeDTO> {
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfEmployeeDTO> {
     ...
     * @return Success
     */
    create(input: EmployeeDTO | null | undefined): Observable<EmployeeDTO> {
...
export class EmployeeDTO implements IEmployeeDTO {
    ...
    dno: number | undefined;
    id: number | undefined;
    departmentDepartname: string| undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.dno = data["dno"];
            this.id = data["id"];
            this.departmentDepartname = data["departmentDepartname"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["dno"] = this.dno;
        data["id"] = this.id;
        data["departmentDepartname"] = this.departmentDepartname;
        return data; 
    }
